...
DEBUG_MACROS = -DRUN_MINIMIZERINDEX_MAIN_
RELEASE_MACROS = -DRUN_MINIMIZERINDEX_MAIN_
...
debug: $(OBJ_FILES_DEBUG) 
	@echo [LD DEBUG] $<
	@mkdir -p $(dir $(BIN))
	@$(GCC) $(LD_FLAGS) $(LIB_DIRS) $(DEBUG_MACROS) -o $(BIN) $(OBJ_FILES_DEBUG) $(LD_LIBS)

$(OBJ_DEBUG_DIR)/%.o: %.cc $(H_FILES)
	@echo [CP DEBUG] $<
	@mkdir -p $(dir $@)
	@$(GCC) $(CC_LIBS) $(INCLUDE) $(CC_FLAGS_DEBUG) $(DEBUG_MACROS) -o $@ $<
...
release: $(OBJ_FILES_RELEASE)
	@echo [LD RELEASE] $<
	@mkdir -p $(dir $(BIN))
	@$(GCC) $(LD_FLAGS) $(LIB_DIRS) $(RELEASE_MACROS) -o $(BIN) $(OBJ_FILES_RELEASE) $(LD_LIBS)

$(OBJ_RELEASE_DIR)/%.o: %.cc $(H_FILES)
	@echo [CP RELEASE] $<
	@mkdir -p $(dir $@)
	@$(GCC) $(CC_LIBS) $(INCLUDE) $(CC_FLAGS_RELEASE) $(RELEASE_MACROS) -o $@ $<
